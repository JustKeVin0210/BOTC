...
def write_excel(json_file, image_dir, save_dir):
    ...
    for i, (role_first, role_other) in enumerate(zip(script_roles_fisrt_night, script_roles_other_night)):
        if role_first:
            ...
            role_first_infolist = [None, role_first.get("name"), format_dict.get(role_first.get("team")).get("team_cn"),
        ...
        if role_other:
            ...
            role_other_infolist = [None, role_other.get("name"), format_dict.get(role_other.get("team")).get("team_cn"),
